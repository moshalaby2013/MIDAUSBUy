            ...
            <div class="banner-wrap">
                <div id="swiper" class="swiper-container swiper-container-horizontal leng-one swiper-no-swiping" style="height: auto; overflow: visible;">
                    <div id="swiper-wrapper" class="swiper-wrapper swiper-wrapper1">
                        <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active swiper-slide-prev" style="background: url(https://cdn.midasbuy.com/images/S5_1920x240a30e99f1.jpg) center center / cover no-repeat; width: 100%; max-width: 100%;"></div>
                    </div>
                </div>
            </div>
            <div class="content">
